          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control" id="participant" name="participant">
                ...
                <option value="Divisi SDM" @if(old("participant",$data->participant) == 'Divisi SDM') selected @endif>Divisi SDM</option>
                <option value="Divisi Operasional" @if(old("participant",$data->participant) == 'Divisi Operasional') selected @endif>Divisi Operasional</option>
                <option value="Divisi Pemasaran" @if(old("participant",$data->participant) == 'Divisi Pemasaran') selected @endif>Divisi Pemasaran</option>
